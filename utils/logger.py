...
class Logger():
    #Вариант, если запускать из директории final_project
    ...
    #Максим, если ты балбес и запустил py -m pytest -s -v через final_project\tests, то должна исп след коснструкиця:
